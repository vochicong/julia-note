...
# ╔═╡ 985efc72-015a-11ec-1f24-432b46102439
begin
	using Conda
	using Pandas
	Conda.add("pandas")
...
# ╔═╡ f1c06144-f25f-43cc-9c64-2ef7298d3f07
df = DataFrame(Dict(:g=>[1,2,3,1,2,1], :e=>[10,20,31,11,22,12]))

# ╔═╡ 55e72978-f0b7-47e1-ae48-a2a4c4570baa
agg(groupby(df, :g), ["sum"])
