...
# ╔═╡ 1b899054-0148-4f44-be9e-f490f2664663
begin
	using Turing
	using StatsPlots
	using Random
...
# ╔═╡ 5ec91988-c71d-11eb-09f4-d1bb81226c4e
data = begin
	...
	Random.seed!(12)
	rand(Bernoulli(p_true), last(Ns))	
end

# ╔═╡ 35ee008b-8aa5-4bbf-891f-c145ee336628
...
# ╔═╡ 14c676bf-cd19-481f-9440-da68a63a28d8
chain = begin
	...
	# Start sampling.
	sample(coinflip(data), HMC(ϵ, τ), iterations)
end

# ╔═╡ 551f82e9-fc2b-407e-a68f-0e1d8d08d6b9
# Plot probability of heads in a coin.
histogram(chain[:p])

# ╔═╡ 86da3947-8aa3-4b1e-a17f-50fa34dba9f6
...
# ╔═╡ d458c0a8-2f36-42a7-8985-eb4fea50a4ef
#  Run sampler, collect results
chn = sample(gdemo(1.5, 2), HMC(0.1, 5), 1000)

# ╔═╡ f8bef8b2-1f91-4b0a-9417-7af5e73192da
# Summarise results
describe(chn)

# ╔═╡ 354d6731-e7aa-46f6-be27-9093374c0158
plot(chn)
